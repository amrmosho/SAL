 ...
 */
public class config {
    public  static  String  webServiecURL="http://tabukasl.com/webserves/";
    public  static  String  imagePath="http://tabukasl.com/upload/";
    public  static  String  vidoePath="http://tabukasl.com/upload/";
    /*
